...
using Monofoxe.Samples.CoroutinesDemo;
using Monofoxe.Samples.ECDemo;
using Monofoxe.Samples.GraphicsDemo;
using Monofoxe.Samples.InputDemo;
using Monofoxe.Samples.SceneSystemDemo;
using Monofoxe.Samples.TiledDemo;
using Monofoxe.Samples.UtilsDemo;
using System;
